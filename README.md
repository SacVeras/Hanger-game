...
## tecnic list:
* The game has until this version (v2.6) 3 categories of words, they are: animals, fruits and countries.
...
## lista técnicas:
* O jogo possui até esta versão(v2.6) 3 caégorias de palavras, são elas: animais, frutas e países.
